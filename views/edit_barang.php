    ...
    <!-- start isi dari konten card -->
       ...
       <div class ="row">
        ...
        <div class="col-lg-8">
            ...
            <?php
            foreach ($barang->edit($_GET['nip']) as $b) {
                ?>
                             ...
                             <div class="form-group">
                                    <input type="number" class="form-control form-control-user"
                                     id = "exampleInputEmail" value="<?= $b->nip ?>" name="nip" hidden>
        
                                </div>
                             
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user"
                                     id = "exampleInputEmail" value="<?= $b->nama_pegawai ?>" name="nama_pegawai">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user"
                                     id = "exampleInputEmail" value="<?= $b->mata_pelajaran ?>" name="Mata_pelajaran">
        
                                </div>
                                <div class="input-field">
                                    <input type="submit" class="btn btn-primary btn-user btn-block"
                                    value="Ubah Pegawai" id="" name="login">
